...
module riscv32im_writeback_router (
  ...
  input  riscv32im_muldiv_rsp_info_t   muldiv_rsp_i,
  ...
  always_comb begin
    ...
    end else if (muldiv_wb_selected_i && muldiv_rsp_i.rd_write) begin
      retire_write_valid_o = 1'b1;
      retire_write_addr_o = muldiv_rsp_i.rd_addr;
      retire_write_data_o = muldiv_rsp_i.rd_wdata;
